...
{
    /// <summary>
    /// The game, as a component: owns a registry, ticks it, and is what markers in a
    /// scene find their registry through.
    ///
    /// This exists so <see cref="AtlasMarkerBehaviour"/> has something to find that is
    /// <b>not</b> a static. A scene-level provider keeps split-screen possible - two of
    /// these, each with its own camera and its own markers - which a singleton would
    /// quietly make impossible on the day someone tried.
    ///
    ...
    public sealed class AtlasRegistryBehaviour : MonoBehaviour
    {
        ...
        /// <summary>The registry this component owns. Created on first access, so a
        /// marker that wakes before this component still finds one.</summary>
        ...
        /// wired without a script.</summary>
